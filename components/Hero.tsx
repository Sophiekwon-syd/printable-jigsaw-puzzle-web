...
import promo_img from './promo_img.png';
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
          <div className="text-center lg:text-left">
            ...
            <div id="download" className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center">
              {/* Apple Store Button */}
              <a href="https://apps.apple.com/au/app/printable-jigsaw-puzzle/id6758417556" className="flex items-center bg-black text-white px-8 py-3 rounded-xl hover:bg-slate-800 transition-all transform hover:-translate-y-1 shadow-lg">
